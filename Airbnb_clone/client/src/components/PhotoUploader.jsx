    ...
    <>
      ...
      <div className="mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        {addedPhotos.length > 0 &&
          addedPhotos.map((filename, indx) => (
            <div className="flex relative" key={indx}>
              <img
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black bg-opacity-60 rounded-2xl py-1 px-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
