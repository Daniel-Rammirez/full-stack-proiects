      ...
      {action === "new" && (
        <div>
          <form className="flex flex-col gap-4">
            <label>Title: </label>
            <input type="text" placeholder="My lovely place" />
            <label>Address: </label>
            <input type="text" placeholder="address" />
            <label>Photos: </label>
            <div className="flex gap-4 items-center">
              <input type="text" placeholder="Add using a link ...jpg" />
              <button className="bg-airbnb text-white rounded-full w-40 h-11">
                Add photo
              </button>
            </div>
            <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              <button className="border bg-transparent rounded-2xl p-8 text-2xl text-gray-500 inline-flex gap-2 mr-auto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="grid grid-cols-3 text-center gap-2">
              <div>
                ...
                <input type="text" className="" placeholder="15:00" />
              </div>
              <div>
                <label>Check Out</label>
                <input type="text" className="" placeholder="11:00" />
              </div>
              <div>
                <label>Max guests</label>
                <input type="text" className="" placeholder="2" />
              </div>
            </div>
            <div>
